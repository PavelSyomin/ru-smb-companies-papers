...
**Abstract:** the present study is an analysis of law firm naming in Russia, with a particular focus on the geographical aspects of this phenomenon. The primary objective of this research is to ascertain the impact of the spatial relations between the regions of the country, specifically those of a neighboring, proximity, and belonging to a parent-level subdivision, on the naming of law firms. To conduct the analysis, data regarding law firms is extracted from the open dumps of the state registry of small and medium-sized businesses. The names of the firms are transformed into numerical vectors, subsequently clustered with KMeans method, and then manually grouped to identify naming strategies. Numerical representations of law firm names within each region are averaged to get region embeddings, which are then used to compare the names of law firms in different regions. The research findings indicate that regions situated in closer proximity to one another or sharing a common border tend to adopt slightly more similar law firm names. Furthermore, regions that are part of the same economic region also display a greater degree of similarity in law firm names. Three primary strategies of law firm naming are “Form”, “Law“, and “Service”. Volga and North Caucasus economic regions are characterized by the predominance of “Service” strategy, whereas Volga-Vyatka economic region exhibits a “Law” strategy, and the remaining territories demonstrate a combination of naming strategies. The results of the study lend support to the widely-used classification of economic regions in Russia. The findings also underscore the impact of neighboring, proximity, and interconnectivity on the economic and cultural attributes of the regions. The administrative open data processing techniques, as well as the methods of working with firm names based on neural networks proposed in this paper, may be used by other economic geographers for their own research purposes.
...
Map in Figure 4 depicts a dominant naming strategy in regions of Russia. As “Form” naming is used by a minority of law firms across all regions, it is not shown. European South of Russia and Volga economic region are characterized by a prevalence of “Service” strategy. In other parts of the country, an irregular mixture of both “Law” and “Service” naming strategies is observed.
